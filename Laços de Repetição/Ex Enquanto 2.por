...
programa
{
	...
	funcao inicio()
	{
		...
		leia(num)
		escreva(num) //aqui apresenta o valor digitado
		enquanto (num <= 100) { //estabelece a condição de parada para quando a multiplicação passar 100
			num = num*3
			escreva(" ", num) //imprime os resultados
		}
	}
}
/* $$$ Portugol Studio $$$ 
